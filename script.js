...
if(item.isWedBlock) {
    ...
    div.className = "macro-battesimo"; // Mantengo la classe per il layout, ma cambio gli stili inline
    div.id = "slot-" + item.id;
    
    // FORZATURA COLORI MATRIMONIO: Blu Scuro e Sfondo Grigio/Blu tenue
    div.style.background = "#f0f2f5"; 
    div.style.border = "2px solid #1a237e"; 
    div.style.borderRadius = "15px";
    div.style.overflow = "hidden";
    div.style.marginBottom = "20px";

    div.innerHTML = `
    <div class="titolo-matrimonio" style="background:#1a237e; color:white; padding:10px; display:flex; align-items:center; justify-content:space-between;">
    <div style="width:30px;"></div> <input type="text" value="${item.titolo_wed || 'MATRIMONIO'}" 
           style="background:none; border:none; color:white; font-weight:900; text-align:center; flex:1; outline:none; font-family:inherit; font-size:18px;" 
